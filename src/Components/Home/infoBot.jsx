...
function InfoBot() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      var newPosition = Math.max(position - window.scrollY, 0);
  ...
  return (
    <div className="md:h-[70vh] w-full grid md:grid-cols-[40%_60%] bg-white relative shadow-[0_0_10px_rgba(0,0,0,.3)]">
      {/* Chatbot-Info */}
      ...
      {/* About-ChatBot */}
      <div
        className="flex flex-col justify-center gap-8 w-full md:w-2/3 justify-self-center p-8 md:p-0"
        style={
