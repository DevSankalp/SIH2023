...
function Dashboard() {
  ...
  return (
    <div className="Dashboard h-[100vh] flex flex-col items-center bg-[#f3f6fd]">
      <div className="flex items-center w-full h-max p-4 gap-8">
        <a href="/">
          <img src={logoImg} alt="" className="w-10 rounded-full" />
        </a>
        <h1>DashBoard</h1>
      </div>
      <div className="grid grid-cols-[30%70%] gap-8 h-[87%] w-full place-items-center">
        <User />
        <Main />
      </div>
    </div>
